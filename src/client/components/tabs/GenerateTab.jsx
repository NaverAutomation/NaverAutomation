...
const GenerateTab = React.memo(
  ({
    ...
    // ── UI 및 전환 상태 ──
    const [mainTab, setMainTab] = useState('compose'); // 'compose' | 'queue'
    ...
    return (
      <div className="flex flex-col gap-6">
        {/* ── 1. 상단 메인 탭 바 ── */}
        <div className="flex bg-base-300 p-1.5 rounded-xl">
          <button
          ...
          <button
            ...
            className={`flex-1 py-3 text-center rounded-lg font-black text-sm transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 ${
              mainTab === 'queue'
                ? 'bg-primary text-primary-content shadow-md scale-[1.01]'
                : 'text-base-content/60 hover:text-base-content font-bold'
            }`}
            ...
            {scheduledPosts.length > 0 && (
              <span
                className={`badge badge-sm font-bold ${
                  mainTab === 'queue' ? 'badge-primary-content text-primary' : 'badge-warning'
                }`}
              >
                      ...
                      <div className="flex flex-col w-full mt-2">
                        ...
                        <div className="flex gap-3 w-full">
                          <Btn
                            ...
                            disabled={
                              manualScheduling || !manualScheduledAt || accounts.length === 0
                            }
                          >
                            {manualScheduling ? (
                ...
                >
                  ...
                  <div className="bg-base-100 p-6 rounded-2xl border border-base-300 shadow-inner space-y-4">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setGenerated((prev) => ({ ...prev, content: e.target.value }))
                      }
                    />
